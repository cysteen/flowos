...
const KPI_DEFS = [
  { label: '双层均达标率', tone: 'ok',
    tip: '所选统计范围内，命中 SLA 策略并完成计时的工单中，响应与解决「双双」都在时效内的占比 = 双达标单数 / 统计单数 ×100%。' },
  { label: '响应达标率', tone: 'normal',
    tip: '所选统计范围内，响应在 SLA 时效内完成的占比 = 响应达标数 / 统计数 ×100%。' },
  { label: '解决达标率', tone: 'normal',
    tip: '所选统计范围内，解决在 SLA 时效内完成的占比 = 解决达标数 / 统计数 ×100%。' },
  { label: '超时单', tone: 'warn',
    tip: '所选统计范围内，响应或解决「任一」超出 SLA 时效的工单绝对数（去重工单）。' },
];
