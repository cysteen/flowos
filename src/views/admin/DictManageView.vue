...
const dataMap: Record<string, DictData[]> = reactive({
  ...
  workorder_status: [
    ...
    { code: 'D26', label: '自动刷机中', value: 'AUTO_FLASHING', sort: 18, status: '启用', colorType: 'primary', remark: '刷机单 · SLA停表' },
    { code: 'D18', label: '已结案', value: 'SETTLED', sort: 19, status: '启用', colorType: 'success', remark: '' },
    { code: 'D19', label: '已关闭', value: 'CLOSED', sort: 20, status: '启用', colorType: 'success', remark: '' },
    { code: 'D20', label: '已强结', value: 'FORCE_CLOSED', sort: 21, status: '启用', colorType: 'success', remark: '' },
    { code: 'D21', label: '已转咨询', value: 'TRANSFERRED_CONSULT', sort: 22, status: '启用', colorType: 'default', remark: '' },
    { code: 'D22', label: '已转建议', value: 'TRANSFERRED_SUGGESTION', sort: 23, status: '启用', colorType: 'default', remark: '' },
    { code: 'D23', label: '已转商机', value: 'TRANSFERRED_LEAD', sort: 24, status: '启用', colorType: 'default', remark: '' },
    { code: 'D24', label: '已取消', value: 'CANCELLED', sort: 25, status: '启用', colorType: 'success', remark: '' },
    { code: 'D25', label: '直接结案', value: 'DIRECT_SETTLED', sort: 26, status: '启用', colorType: 'success', remark: '' },
  ],
  priority: [
