...
const BASE_TICKETS: Ticket[] = [
  ...
  { serviceScore: 2,
    ...
    // 已联系：催补后坐席已回电 → 催补待回**不收**（PRD-830 §10.1）
  ...
  {
    id: 't5a', no: 'LCMN-20260804-81001', type: '咨询', channel: '电话',
  ...
  {
    id: 'fd-d3', no: 'LCMN-20260817-83003', type: '投诉', channel: '在线客服',
  ...
  {
    id: 'fd-d4', no: 'LCMN-20260817-83004', type: '投诉', channel: '电话',
  ...
  {
    id: 'fd-d7', no: 'LCMN-20260817-83007', type: '咨询', channel: '电话',
  ...
  // D8 已解决·无子单：点补充 → **新建一张承接子单**；再补一次仍落这张，不建第二张
  {
    id: 'fd-d8', no: 'LCMN-20260817-83008', type: '咨询', channel: '电话',
  ...
  {
    id: 't10', no: 'LCMN-20260714-72330', type: '咨询', channel: '小程序',
  ...
  {
    id: 't12', no: 'LCMN-20260716-72901', type: '投诉', channel: 'APP',
  ...
  {
    id: 't28', no: 'LCMN-20260708-59880', type: '投诉', channel: '在线客服',
