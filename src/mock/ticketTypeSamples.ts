...
export const TYPE_SAMPLES: Record<string, TicketTypeSample> = {
  ...
  咨询: {
    detail: {
      ...
      insight: {
        contactCount: 2, historyCount: 5, complaintCount: 0, sameTypeCount: 4, recent30Count: 6,
        dunningCount: 0, supplementCount: 1, relatedCount: 2,
      },
      aiInsight: {
        customerBrief: '咨询为主、无投诉，联系频次中等',
    ...
    tabData: {
      ...
      supplementRecords: [
        { id: 's1', who: '张晓芸(一线)', when: '今天 09:18', supplementType: '补充信息', content: '客户补充 WiFi 配置截图', attachments: ['配置截图.png'] },
      ],
      dunningRecords: [],
      contactRecords: [
        {
  ...
  商机: {
    detail: {
      ...
      insight: {
        contactCount: 1, historyCount: 3, complaintCount: 0, sameTypeCount: 2, recent30Count: 3,
  ...
  建议: {
    detail: {
      ...
      insight: {
        contactCount: 1, historyCount: 2, complaintCount: 0, sameTypeCount: 1, recent30Count: 2,
        dunningCount: 0, supplementCount: 0, relatedCount: 1,
      },
      aiInsight: {
